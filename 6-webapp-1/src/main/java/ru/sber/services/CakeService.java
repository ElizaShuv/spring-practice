...
/**
 * Класс, содержащий список тортов и метод их поиска
 */
@Service
public class CakeService {
    private List<Cake> cakes = new ArrayList<>(List.of(
            new Cake("Морковный торт", "Пряные морковно-ореховые бисквиты с сырным кремом и апельсиновым конфитюром", "img/cake9.jpg", "морковь орех сырный крем апельсин"),
